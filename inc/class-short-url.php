...
class Short_URL {
	...
	public function init() {
		...
		$this->generic_base_url = $home_url['host'];
	}
			...
			<form action="options.php" method="post">
				...
				<table class="form-table">
					<tr>
						...
						<td><input type="text" id="base_url" value="<?php echo esc_url( $options[ 'base_url' ] ); ?>" name="<?php echo esc_attr( $this->options_name ); ?>[base_url]" /></td>
